...
- **fatia:** SEGURANÇA / dívida técnica pré-produção do TOM (LA Organizer) — Supabase cesnbnrynvxvgdhfmaua + engine Node na VPS + PWA Vercel
- **evidência:** SELECT em governance_credentials (18 linhas): campo campos (jsonb) contém valor "sk-proj-‹REDIGIDO-VER-INCIDENTE-KEY-LEAK›" (chave OpenAI ativa, sensivel:true), "AIza‹REDIGIDO-VER-INCIDENTE-KEY-LEAK›" (Gemini, sensivel:true) e "‹REDIGIDO-WAHA-VER-INCIDENTE-KEY-LEAK›" (Waha). RLS está LIGADA com 4 policies director-only (qual: current_collab_role()='director'), o que é bom para o caminho authenticated.
...
1) Segredos em TEXTO PURO existem. Tabela governance_credentials (18 linhas). Linha id=f87225df-a358-4eea-9157-ffb3e30a07a9 (nome "Chave openai", servico "Openai") tem campos.valor="sk-proj-‹REDIGIDO-VER-INCIDENTE-KEY-LEAK›" em cleartext (sensivel:true). Linha ef5ce094 ("LA Report Gemini key") tem "AIza‹REDIGIDO-VER-INCIDENTE-KEY-LEAK›". Linha 5d30e6d5 ("Chave Waha") tem "‹REDIGIDO-WAHA-VER-INCIDENTE-KEY-LEAK›".
