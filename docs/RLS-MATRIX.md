...
- **Sprint 4 (28/04/2026):** Auditoria completa (30 tabelas, 41 policies). Harness `scripts/rls-test.js` com 16 invariantes. 5 leaks fechados (collaborators PII, project_checkpoints, project_members, marker_logs, task_reminders), 2 gaps funcionais cobertos (ritual_logs read-own, user_preferences insert-own). Matriz CONGELADA. Re-rodar harness antes de qualquer mudança em policy.
