...
8. CORTES NO TEXTO SÃO NOSSOS, NÃO DO USUÁRIO: a conversa pode estar truncada (mensagens longas, áudios). Texto que termina abrupto, reticências ou frase incompleta = truncagem do LOG, não fala interrompida do usuário. NUNCA conclua "o áudio do usuário foi cortado", "a frase não terminou" ou que o TOM inventou o resto a partir de um corte. Se a mensagem parece cortada, IGNORE o corte — não vire finding.
