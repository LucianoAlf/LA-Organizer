...
export default defineConfig(function (_a) {
    ...
    var __pkgVersion = process.env.npm_package_version || '0.0.0';
    var __buildSha = (process.env.VERCEL_GIT_COMMIT_SHA || '').slice(0, 7) || 'dev';
    var __buildTime = new Date().toISOString();
