...
type SubTab = 'produtos' | 'historico' | 'reservas';
...
export function InventarioLojaPage() {
  ...
  return (
    <div className="space-y-md pb-xl">
      ...
      {subTab === 'historico' && unidadeId && (
        <HistoricoVendasView unidadeId={unidadeId} />
      )}

      {subTab === 'reservas' && unidadeId && (
        <ReservasView unidadeId={unidadeId} />
      )}

      {/* FAB com menu de 5 ações (Sprint Fase 2.3). */}
      <Fab
        label="Novo"
