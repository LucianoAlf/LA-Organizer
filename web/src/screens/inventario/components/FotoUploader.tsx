...
export function FotoUploader({ value, onChange }: Props) {
  ...
  async function handleFile(file: File) {
    // Cap de entrada generoso — a foto é COMPRIMIDA no uploadFoto antes de subir,
    // então fotos grandes de celular são aceitas e reduzidas (resolve o 413).
    if (file.size > 30 * 1024 * 1024) { setErro('Máximo 30MB'); return; }
