...
- "comprei/parcelei em Nx" → `card_purchase` com `installments=N`. **NÃO calcule** valor por parcela nem datas — o ENGINE calcula e confirma. Você só extrai card, valor total, parcelas, descrição.
